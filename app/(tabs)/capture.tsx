...
<parameter name="path">app/(tabs)/_layout.tsx</parameter>
<parameter name="old_str">      <Tabs.Screen
        name="index"
        options={{
          title: 'Home',
      ...
      /></parameter>
<parameter name="new_str">      <Tabs.Screen
        name="index"
        options={{
          title: 'Home',
          tabBarIcon: ({ color, size }) => (
...
<invoke name="str_replace_editor">
<parameter name="command">str_replace</parameter>
<parameter name="path">app/(tabs)/index.tsx</parameter>
<parameter name="old_str">  const handleCapture = () => {
    // TODO: Navigate to camera/mood capture screen
    console.log('Capture pressed');
  };</parameter>
<parameter name="new_str">  const handleCapture = () => {
