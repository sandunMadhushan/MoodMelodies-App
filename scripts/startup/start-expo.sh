...
echo -e "${BLUE}🎯 Using tunnel mode for maximum compatibility!${NC}"
echo -e "${BLUE}📲 This works from any network - no manual IP configuration needed!${NC}"
echo ""

# Use tunnel mode for best compatibility with Expo Go
